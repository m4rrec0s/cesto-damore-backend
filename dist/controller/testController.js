...
exports.testController = {
    ...
    async testLocalUpload(req, res) {
        ...
        try {
            ...
            console.log("🚀 Salvando imagem localmente...");
            const imageUrl = await (0, localStorage_1.saveImageLocally)(req.file.buffer, req.file.originalname, req.file.mimetype);
    ...
    async listImages(req, res) {
        ...
        try {
            const images = (0, localStorage_1.listLocalImages)();
            res.json({
                success: true,
    ...
    async deleteImage(req, res) {
        ...
        try {
            await (0, localStorage_1.deleteImageLocally)(imageUrl);
            res.json({
                success: true,
...
exports.default = exports.testController;
