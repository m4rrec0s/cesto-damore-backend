...
async function testConnection() {
    ...
    const urlWithoutPassword = connectionString.replace(/postgresql:\/\/([^:]+):([^@]+)@/, "postgresql://$1:***@");
    ...
    `;
      ...
      `;
        ...
        `;
            ...
            console.log("   2. A tabela existe no projeto Supabase 'n8n-paulo-automacao'");
        }
