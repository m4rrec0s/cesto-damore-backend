    ...
    buildOrderConfirmationMessages(orderData) {
        ...
        if (orderData.delivery) {
            ...
            if (orderData.delivery.date) {
                ...
                teamMessage += `${this.formatToBrasiliaTime(orderData.delivery.date)}\n`;
            }
        }
        ...
        customerMessage += `💳 *Pagamento:* ${this.formatPaymentMethod(orderData.paymentMethod || "Não especificado")}\n\n`;
